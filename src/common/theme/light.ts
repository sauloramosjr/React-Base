...
export const LightTheme: Thema = {
  palette: {
    ...
    primary: {
      ...
      light: { value: '#70b8e2', contrastText: '#fff' },
      dark: { value: '#1d77ac', contrastText: '#fff' },
    },
    secondary: {
      main: { value: '#cfcfcf', contrastText: '#fff' },
      light: { value: '#edecec', contrastText: '#fff' },
      dark: { value: '#808080', contrastText: '#fff' },
    },
    error: {
      main: { value: '#b74136', contrastText: '#fff' },
      light: { value: '#eba39d', contrastText: '#fff' },
